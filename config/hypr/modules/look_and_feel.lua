...
-- Keep only very short, subtle transitions. Avoid spring/pop-in effects
-- because they are more noticeable during normal window management.
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1.5, bezier = "quick", style = "popin 90%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.5, bezier = "quick", style = "slide 10%" })
hl.animation({ leaf = "fadeIn", enabled = false, speed = 2, bezier = "almostLinear" })
